...
def upload_file_lambda(event, context):
    ...
    files_table.put_item(Item={'fileName':fileName, 'fileType':fileType, 'fileSize':fileSize, 'fileCreated':fileCreated, 'fileLastModefied':fileLastModefied, 'description':description, 'tags':tags, 'owner':owner, 'haveAccsess':haveAccsess})
